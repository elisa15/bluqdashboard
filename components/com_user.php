...
if($action == 'save')
{
	...
	{
		$err_msg = 'Please Select Access Level.';
	}
	...
	{	
		...
		if(mysql_query ($sql))
		{
			...
			$sucess_msg = '<div class="message success"><p>User has been successfully Added!</p></div>';
			$view = 'list';
		}
	}	
}
else if($action == 'update')
{
	...
	{	
		...
		if(mysql_query ($sql))
		{
			...
			$sucess_msg = '<div class="message success"><p>User has been successfully updated!</p></div>';
			$view = 'edit';
		}
		else
		{
...
$content_template = 'components/block/blk_com_user.php';
